...
if(WIN32) # The only platform it makes sense to check for DirectX11 SDK
	...
	if( MSVC OR CLANG AND NOT MSVC90 )
		MESSAGE("-----------------------------")
		# Windows 10.x SDK
		...
		list(APPEND W10SDK_VERSIONS "10.0.10240.0" "10.0.14393.0" "10.0.15063.0" "10.0.16299.0" "10.0.19041.0")	# enumerate well known release versions
	...
	message("DirectX11_INCLUDE_DIR ${DirectX11_INCLUDE_DIR}")
	message("DirectX11_LIBRARY ${DirectX11_LIBRARY}")
